...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="service_hero"
      className="flex h-screen w-screen relative justify-center items-center overflow-hidden"
    >
      ...
      {/* Decorative Elements */}
      <motion.div
        className="absolute top-1/4 left-1/4 w-32 h-32 rounded-full bg-amber-400/10"
      ...
      <motion.div
        className="absolute bottom-1/4 right-1/4 w-48 h-48 rounded-full bg-indigo-500/10"
        variants={floatingShapeVariants}
        initial="initial"
        animate="animate"
        custom={2}
