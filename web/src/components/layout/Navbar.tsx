...
const Navbar: React.FC = () => {
  return (
    <div className="w-screen p-[2rem] flex items-csenter justify-between bg-transparent backdrop-blur-sm fixed">
      ...
      <nav className="flex py-[1rem] px-[2rem] justify-center items-center gap-[1.2rem] rounded-[6rem] bg-[#100e34] shadow-[2px_6px_4px_0px_rgba(0,0,0,0.25)] text-white text-center font-inter text-[1rem] font-medium">
