    ...
    return (
        ...
        >
            <div className="flex justify-between items-start mb-4">
                <div
                    className="cursor-default flex items-center space-x-2 bg-white border rounded-full px-4 py-2"
                >
                ...
                <div className="flex flex-col gap-3 items-center justify-center">
                    ...
                    <div className="flex flex-wrap justify-center items-center space-x-6 text-sm font-inter">
                        <Link href="/about" className="transition-all duration-300 hover:font-bold">About Us</Link>
                        <Link href="/projects" className="transition-all duration-300 hover:font-bold">Our Projects</Link>
                        <Link href="/" className="transition-all duration-300 hover:font-bold">Home</Link>
                        <Link href="/join-us" className="transition-all duration-300 hover:font-bold">Join Us</Link>
                        <Link href="/contact-us" className="transition-all duration-300 hover:font-bold">Contact Us</Link>
                    </div>
                </div>
                <div
                    className="flex cursor-pointer items-center space-x-2 bg-white border rounded-full p-2">
